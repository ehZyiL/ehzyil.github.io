---
title: 一条SQL更新语句是如何执行的？ to connect to the Docker daemon socket at unix:///var/run/docker.sock:'
author: ehzyil
tags:
  - MySQL
categories:
...
> 转载[MySQL实战45讲| 02 | 日志系统：一条SQL更新语句是如何执行的？]()
...
从前面的`一条SQL查询语句是如何执行的？`可以知道更新语句也会走一遍相同的流程。
...
![image-20231213151704919](../../../images/2023/assets/image-20231213151704919.png)
...
![image-20231213151654387](../../../images/2023/assets/image-20231213151654387.png)
...
为什么必须有“两阶段提交”呢？这是为了让两份日志之间的逻辑一致。要说明这个问题，我们得从**怎样让数据库恢复到半个月内任意一秒的状态？**说起。
